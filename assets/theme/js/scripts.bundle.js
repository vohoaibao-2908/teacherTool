...
var KTUtil = (function () {
  var resizeHandlers = [];
  var breakpoints = { sm: 544, md: 768, lg: 1024, xl: 1200 };
...
var KTAvatar = function (elementId, options) {
  ...
  var Plugin = {
    ...
    addEvent: function (name, handler, one) {
      the.events.push({ name: name, handler: handler, one: one, fired: false });
      return the;
    },
  };
...
var KTHeader = function (elementId, options) {
  ...
  var defaultOptions = {
    ...
    minimize: { mobile: false, desktop: false },
  };
  var Plugin = {
    construct: function (options) {
...
var KTWizard = function (elementId, options) {
  ...
  var defaultOptions = { startStep: 1 };
  var Plugin = {
    construct: function (options) {
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    ...
    datatable.API = { record: null, value: null, params: null };
    var Plugin = {
      isInit: false,
      cellOffset: 110,
      iconOffset: 15,
  ...
  $.fn[pluginName].defaults = {
    data: {
      ...
      source: null,
      pageSize: 10,
      saveState: { cookie: false, webstorage: true },
      serverPaging: false,
    ...
    editable: false,
    columns: [],
    search: { onEnter: false, input: null, delay: 400 },
    rows: {
      callback: function () {},
...
var KTLayout = (function () {
  ...
  var initHeader = function () {
    ...
    var options = { offset: {}, minimize: { desktop: false, mobile: false } };
  ...
  var initHeaderMenu = function () {
    ...
    headerMenu = new KTMenu("kt_header_menu", {
      ...
      accordion: { slideSpeed: 200, expandAll: false },
    });
  };
